...
<p>ADL99 understands the unique challenges facing law firms. We help you protect client confidentiality, maintain legal privilege, and meet your ethical obligations while defending against increasingly sophisticated cyber threats.</p>`,
    acf: {
      ...
      whyChooseUs: [
        { item: "Deep understanding of Australian legal practice requirements" },
        { item: "Solutions scaled to firms of all sizes" },
        { item: "Minimal disruption to billable work" },
        { item: "Ongoing support and monitoring" },
        { item: "Help meeting client security requirements" },
      ],
    },
  },
  {
...
<p>ADL99 provides healthcare-specific cybersecurity solutions that balance security with operational efficiency, helping you meet privacy regulations while keeping your focus on patient outcomes.</p>`,
    acf: {
      ...
      whyChooseUs: [
        { item: "Deep understanding of Australian healthcare privacy requirements" },
        { item: "Experience with all major practice management systems" },
        { item: "Zero disruption to patient care" },
        { item: "Ongoing monitoring and support" },
        { item: "Emergency incident response when you need it" },
      ],
    },
  },
  {
...
<p>ADL99 helps accounting practices implement robust security measures that protect client financial data, meet professional obligations, and defend against business email compromise and other common attack vectors.</p>`,
    acf: {
      ...
      whyChooseUs: [
        { item: "Deep understanding of accounting industry requirements" },
        { item: "Experience with major accounting software platforms" },
        { item: "Tax season-specific security protocols" },
        { item: "Compliance documentation support" },
        { item: "Flexible engagement options" },
      ],
    },
  },
  {
...
<p>ADL99 helps retail chains build comprehensive security programs that protect customer trust, ensure PCI-DSS compliance, and defend against the evolving threats targeting the retail sector.</p>`,
    acf: {
      ...
      whyChooseUs: [
        { item: "PCI DSS compliance expertise" },
        { item: "Multi-location security management" },
        { item: "E-commerce and omnichannel experience" },
        { item: "Supply chain risk assessment" },
        { item: "24/7 threat monitoring available" },
      ],
    },
  },
  {
...
<p>ADL99 helps manufacturers protect operational technology, intellectual property, and supply chain communications from the growing threats targeting the industrial sector.</p>`,
    acf: {
      ...
      whyChooseUs: [
        { item: "OT/IT security expertise" },
        { item: "Legacy system protection" },
        { item: "Production-aware implementation" },
        { item: "Supply chain security focus" },
        { item: "Manufacturing incident response" },
      ],
    },
  },
  {
...
<p>ADL99 helps research institutions balance the open collaboration essential to research with the security needed to protect intellectual property, comply with funder requirements, and defend against nation-state threats.</p>`,
    acf: {
      ...
      whyChooseUs: [
        { item: "Understanding of research culture and collaboration needs" },
        { item: "Export control and DISP compliance expertise" },
        { item: "Scalable identity management" },
        { item: "Nation-state threat awareness" },
        { item: "Funder requirement navigation" },
      ],
    },
  },
];
